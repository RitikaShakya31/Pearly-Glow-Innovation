				...
				<div class="d-flex">
					...
					<div class="navbar-brand-box">
						...
						<a href="<?= base_url() ?>" class="logo logo-light">
							<span class="logo-sm">
								<img src="<?= base_url('assets/img/whitelogo.png') ?>" alt="" height="22">
								<!-- <h3>Classy at home</h3> -->
							</span>
							<span class="logo-lg">
								<img src="assets/img/whitelogo.png" alt="logo" width="200">
								<!-- <h4 style="color: #fff; margin-top: 20px;">Classy At Home</h4> -->
							</span>
						</a>
					</div>
